...
//  AR ruler
//
//  Created by Gregory Kolosov on 28/06/2018.
...
//MARK: - Manipulate With App Methods
...
//MARK: - Functions
    ...
    func calculate() {
        ...
        let distanceFormat = String(format: "%.1f", distance)
    
        updateText(text: "\(distanceFormat) cm", atPosition: end.position)
    }
